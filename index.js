  ...
  constructor(props, context) {
    ...
    this.state.panResponder = PanResponder.create({
      ...
      onPanResponderGrant: () => {
        ...
        this.dy = 0
        this.direction = 'down'
        props.onMoveStart && props.onMoveStart.call(this)
      ...
      onPanResponderRelease: () => {
        if (!this.state.active) return
        this.moved = false
        this.props.onMoveEnd && this.props.onMoveEnd.call(this)
        ...
        // console.log('props in LIB (sortable-listview): ', props);
        console.log('this.props in LIB (sortable-listview): ', this.props);
        this.props.onRowMoved && this.props.onRowMoved.call(this, args)
